...
public interface JavaVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitIfstatement(@NotNull JavaParser.IfstatementContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitElsestatement(@NotNull JavaParser.ElsestatementContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code variableModifier1}
	 * labeled alternative in {@link JavaParser#variableModifier}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitVariableModifier1(@NotNull JavaParser.VariableModifier1Context ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code variableModifier2}
	 * labeled alternative in {@link JavaParser#variableModifier}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitVariableModifier2(@NotNull JavaParser.VariableModifier2Context ctx);
	/**
