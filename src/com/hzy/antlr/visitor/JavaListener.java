...
public interface JavaListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterIfstatement(@NotNull JavaParser.IfstatementContext ctx);
	/**
	 * Exit a parse tree produced by {@link JavaParser#ifstatement}.
	 * @param ctx the parse tree
	 */
	void exitIfstatement(@NotNull JavaParser.IfstatementContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterElsestatement(@NotNull JavaParser.ElsestatementContext ctx);
	/**
	 * Exit a parse tree produced by {@link JavaParser#elsestatement}.
	 * @param ctx the parse tree
	 */
	void exitElsestatement(@NotNull JavaParser.ElsestatementContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by the {@code variableModifier1}
	 * labeled alternative in {@link JavaParser#variableModifier}.
	 * @param ctx the parse tree
	 */
	void enterVariableModifier1(@NotNull JavaParser.VariableModifier1Context ctx);
	/**
	 * Exit a parse tree produced by the {@code variableModifier1}
	 * labeled alternative in {@link JavaParser#variableModifier}.
	 * @param ctx the parse tree
	 */
	void exitVariableModifier1(@NotNull JavaParser.VariableModifier1Context ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by the {@code variableModifier2}
	 * labeled alternative in {@link JavaParser#variableModifier}.
	 * @param ctx the parse tree
	 */
	void enterVariableModifier2(@NotNull JavaParser.VariableModifier2Context ctx);
	/**
	 * Exit a parse tree produced by the {@code variableModifier2}
	 * labeled alternative in {@link JavaParser#variableModifier}.
	 * @param ctx the parse tree
	 */
	void exitVariableModifier2(@NotNull JavaParser.VariableModifier2Context ctx);
	/**
